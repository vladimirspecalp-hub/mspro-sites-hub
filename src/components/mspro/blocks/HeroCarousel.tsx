...
const slides: Slide[] = [
  {
    ...
    title: "Высотные работы. Защита металлоконструкций. Промышленный альпинизм МСПРО",
    subtitle: "Специализируемся на ремонте и покраске дымовых труб",
    description: "Узкоспециализированная компания по высотным работам, ремонту и покраске дымовых труб, покраске линий электропередач"
  },
  {
    id: 2,
    image: "/images/hero-slide-2.png", 
    title: "Пескоструйная очистка металла",
    subtitle: "Антикоррозийная защита металлоконструкций",
    description: "Профессиональная пескоструйная очистка до степени Sa 2,5 и полный комплекс услуг по антикоррозийной защите"
  },
  {
    id: 3,
    image: "/images/hero-slide-3.png",
    title: "Малярные работы на высоте",
    subtitle: "Фасадные и кровельные работы",
    description: "Выполняем малярные, фасадные и кровельные работы любой сложности с соблюдением всех норм безопасности"
  },
  {
    id: 4,
    image: "/images/hero-slide-4.png",
    title: "Обслуживание ЛЭП и АМС",
    subtitle: "Покраска линий электропередач",
    description: "Специализируемся на покраске линий электропередач и обслуживании антенно-мачтовых сооружений"
  },
  {
    id: 5,
    image: "/images/hero-slide-5.png",
    title: "Такелажные работы",
    subtitle: "Монтаж металлоконструкций",
    description: "Выполняем такелажные работы, монтаж металлоконструкций и герметизацию швов"
  },
  {
    id: 6,
    image: "/images/hero-slide-6.png",
    title: "Огнезащита металлоконструкций",
    subtitle: "Профессиональная огнезащита",
    description: "Нанесение огнезащитных составов на металлоконструкции с гарантией качества и долговечности"
  }
];
